/**
 * Professional SVG Icon Components for UniSphere
...
export const GraduationCapIcon: React.FC<IconProps> = ({ size = 20, color = 'currentColor', className }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const StaffIcon: React.FC<IconProps> = ({ size = 20, color = 'currentColor', className }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const ParentIcon: React.FC<IconProps> = ({ size = 20, color = 'currentColor', className }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <circle cx="9" cy="7" r="4"/>
...
export const SchoolIcon: React.FC<IconProps> = ({ size = 20, color = 'currentColor', className }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M3 21h18"/>
...
export const MegaphoneIcon: React.FC<IconProps> = ({ size = 20, color = 'currentColor', className }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const UnlockIcon: React.FC<IconProps> = ({ size = 20, color = 'currentColor', className }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <rect x="3" y="11" width="18" height="11" rx="2" ry="2"/>
...
export const SortIcon: React.FC<IconProps> = ({ size = 20, color = 'currentColor', className }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <line x1="12" y1="5" x2="12" y2="19"/>
...
export const CreditIcon: React.FC<IconProps> = ({ size = 20, color = 'currentColor', className }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <circle cx="12" cy="12" r="10"/>
    <path d="M12 8v8"/>
    <path d="M8 12h8"/>
...
// Science / Laboratory
export const BeakerIcon: React.FC<IconProps> = ({ size = 20, color = 'currentColor', className }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M4.5 3h15"/>
...
// Computer / Monitor
export const MonitorIcon: React.FC<IconProps> = ({ size = 20, color = 'currentColor', className }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
// Technology / Code
export const CodeIcon: React.FC<IconProps> = ({ size = 20, color = 'currentColor', className }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const CpuIcon: React.FC<IconProps> = ({ size = 20, color = 'currentColor', className }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
// Sports / Trophy
export const TrophyIcon: React.FC<IconProps> = ({ size = 20, color = 'currentColor', className }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const TheaterIcon: React.FC<IconProps> = ({ size = 20, color = 'currentColor', className }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    <path d="M2 10v10c0 1.1 3.58 2 8 2s8-.9 8-2V10"/>
    <path d="M5 10v4"/>
    <path d="M13 10v4"/>
    <circle cx="8" cy="14" r="2"/>
    <circle cx="16" cy="14" r="2"/>
    <path d="M18 2a4 4 0 0 1 0 8"/>
    <path d="M22 6a8 8 0 0 1-8 8"/>
  </svg>
);

// More menu (vertical dots)
export const MoreVerticalIcon: React.FC<IconProps> = ({ size = 20, color = 'currentColor', className }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
// Gaming
export const GamepadIcon: React.FC<IconProps> = ({ size = 20, color = 'currentColor', className }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
// Link / Integrations
export const LinkIcon: React.FC<IconProps> = ({ size = 20, color = 'currentColor', className }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
// Briefcase / Business
export const BriefcaseIcon: React.FC<IconProps> = ({ size = 20, color = 'currentColor', className }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
// Pin / Location marker
export const PinIcon: React.FC<IconProps> = ({ size = 20, color = 'currentColor', className }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"/>
    <circle cx="12" cy="10" r="3"/>
  </svg>
...
// Crown / Admin
export const CrownIcon: React.FC<IconProps> = ({ size = 20, color = 'currentColor', className }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const HelpCircleIcon: React.FC<IconProps> = ({ size = 20, color = 'currentColor', className }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <circle cx="12" cy="12" r="10"/>
...
// Wifi
export const WifiIcon: React.FC<IconProps> = ({ size = 20, color = 'currentColor', className }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
// Award / Badge
export const AwardIcon: React.FC<IconProps> = ({ size = 20, color = 'currentColor', className }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
